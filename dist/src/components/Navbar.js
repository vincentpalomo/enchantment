...
const Navbar = (props) => {
    ...
    return (react_1.default.createElement("div", { className: 'relative z-50 flex items-center justify-between h-16 mx-auto max-w-screen-2xl sm:px-6 lg:px-8' },
        react_1.default.createElement("div", { className: 'flex items-center' },
            ...
            react_1.default.createElement("div", { className: `${isMenuOpen ? 'block' : 'hidden'} lg:hidden absolute top-16 bg-white py-2 px-4` },
                ...
                !props.online ? (react_1.default.createElement(react_1.default.Fragment, null,
                    ...
                    react_1.default.createElement("div", { className: 'flex' },
                        ...
                        react_1.default.createElement("span", { className: 'block m-1 font-serif text-xl text-pink-500' }, props.user)),
            ...
            react_1.default.createElement("button", { className: 'block mr-auto text-gray-800 lg:hidden hover:text-gray-600 focus:text-gray-600', onClick: handleToggleMenu }, "\uD83E\uDDD9\u200D\u2642\uFE0F")),
        react_1.default.createElement("div", { className: 'flex items-center' },
            react_1.default.createElement(react_router_dom_1.Link, { to: '/cards' },
                react_1.default.createElement("span", { className: 'hidden font-serif text-4xl text-black' }, "enchantment \uD83E\uDDD9\u200D\u2642\uFE0F"))),
