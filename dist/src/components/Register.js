...
const Register = (props) => {
    ...
    const register = (e) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const register = yield (0, api_1.fetchRegister)(username, password, email, isAdmin, avatar);
            if (register.status) {
    ...
    return (react_1.default.createElement("div", { className: 'py-6 bg-white sm:py-8 lg:py-12' },
        react_1.default.createElement("div", { className: 'px-4 mx-auto max-w-screen-2xl md:px-8' },
            react_1.default.createElement("h2", { className: 'mb-4 text-2xl font-bold text-center text-gray-800 md:mb-8 lg:text-3xl' }, "Register"),
            react_1.default.createElement("form", { className: 'max-w-lg mx-auto border rounded-lg', onSubmit: register },
                react_1.default.createElement("div", { className: 'flex flex-col gap-4 p-4 md:p-8' },
                    ...
                    react_1.default.createElement("div", null,
                        react_1.default.createElement("label", { className: 'inline-block mb-2 text-sm text-gray-800 sm:text-base' }, "Email"),
                        react_1.default.createElement("input", { name: 'email', value: email, required: true, onChange: (e) => setEmail(e.target.value), className: 'w-full px-3 py-2 text-gray-800 transition duration-100 border rounded outline-none bg-gray-50 ring-indigo-300 focus:ring' })),
                    react_1.default.createElement("div", null,
                    ...
                    react_1.default.createElement("button", { type: 'submit', className: 'block px-8 py-3 text-sm font-semibold text-center text-white transition duration-100 bg-gray-800 rounded-lg outline-none ring-gray-300 hover:bg-gray-700 focus-visible:ring active:bg-gray-600 md:text-base' }, "Register")),
                react_1.default.createElement("div", { className: 'flex items-center justify-center p-4 bg-gray-100' },
                    react_1.default.createElement("p", { className: 'text-sm text-center text-gray-500' },
                        ...
                        ' ',
                        react_1.default.createElement(react_router_dom_1.Link, { to: '/login', className: 'text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700' }, "Login")))))));
};
