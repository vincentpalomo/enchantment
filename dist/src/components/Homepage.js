                    ...
                    react_1.default.createElement("div", { className: 'relative items-center gap-12 m-auto lg:inline-flex md:order-first' },
                        react_1.default.createElement("div", { className: 'max-w-xl text-center lg:text-left' },
                            react_1.default.createElement("div", null,
                                react_1.default.createElement("p", { className: 'text-2xl font-medium tracking-tight text-black sm:text-4xl' }, "Battle for the Realm"),
                                react_1.default.createElement("p", { className: 'max-w-xl mt-4 text-base tracking-tight text-gray-600' }, "Enter a realm of wizards, dragons, and elves. Build your deck and battle opponents with creatures, spells, and artifacts. Who will reign supreme?")),
