    ...
    <div className='flex items-center justify-between h-16 mx-auto max-w-screen-2xl sm:px-6 lg:px-8'>
      ...
      <div className='flex justify-end flex-1 mr-auto'>
        <Link to='/home' className='active:text-pink-500'>
          <button className='m-2 font-serif text-xl text-black hover:text-pink-500 focus:text-pink-500'>home</button>
        </Link>
        <Link to='/cards' className='active:text-pink-500'>
          <button className='m-2 font-serif text-xl text-black hover:text-pink-500 focus:text-pink-500'>cards</button>
        </Link>
        {/* <span>------</span> */}
        <Link to='/decks' className=' active:text-pink-500'>
          <button className='m-2 font-serif text-xl text-black hover:text-pink-500 focus:text-pink-500'>decks</button>
        </Link>
        <Link to='/about' className=' active:text-pink-500'>
          <button className='m-2 font-serif text-xl text-black hover:text-pink-500 focus:text-pink-500'>about</button>
        </Link>
      </div>
